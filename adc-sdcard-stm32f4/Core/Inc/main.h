...
#define SENSOR_INDUT_Pin GPIO_PIN_11
#define SENSOR_INDUT_GPIO_Port GPIOF
#define GPS_TX_Pin GPIO_PIN_10
#define GPS_TX_GPIO_Port GPIOB
#define GPS_RX_Pin GPIO_PIN_11
#define GPS_RX_GPIO_Port GPIOB
#define MAX232_TX_Pin GPIO_PIN_9
#define MAX232_TX_GPIO_Port GPIOA
#define MAX232_RX_Pin GPIO_PIN_10
#define MAX232_RX_GPIO_Port GPIOA
#define SOFT_RESET_Pin GPIO_PIN_3
#define SOFT_RESET_GPIO_Port GPIOD
#define SOFT_RESET_EXTI_IRQn EXTI3_IRQn
#define BUTTON_AUTOCALIB_Pin GPIO_PIN_7
#define BUTTON_AUTOCALIB_GPIO_Port GPIOD
